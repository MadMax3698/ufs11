<?php
    ...
    function portfolio_init() {
        register_post_type( 'portfolio', array(
            'labels'                => array(
                ...
                'singular_name'         => __( 'Portfolioo', 'ufs11' ),
                'all_items'             => __( 'Tutti portfolio', 'ufs11' ),
                ...
                'filter_items_list'     => __( 'Filstra la lista dei portfolio', 'ufs11' ),
                ...
                'not_found'             => __( 'Nessun portfolio trovato', 'ufs11' ),
                'not_found_in_trash'    => __( 'Nessun portfolio trovato nel cestino', 'ufs11' ),
                'parent_item_colon'     => __( 'Portfolioo superiore:', 'ufs11' ),
    ...
    function portfolio_updated_messages( $messages ) {
        ...
        $messages['portfolio'] = array(
            ...
            1  => sprintf( __( 'Portfolio aggiornato. <a target="_blank" href="%s">Guarda portfolio</a>', 'ufs11' ), esc_url( $permalink ) ),
            2  => __( 'Custom campo aggiornato.', 'ufs11' ),
            3  => __( 'Custom campo cancellato.', 'ufs11' ),
            4  => __( 'Portfolio aggiornato.', 'ufs11' ),
            ...
            /* translators: %s: post permalink */
            6  => sprintf( __( 'Portfolio published. <a href="%s">Guarda Portfolioo</a>', 'ufs11' ), esc_url( $permalink ) ),
            7  => __( 'Portfolioo salvato.', 'ufs11' ),
            /* translators: %s: post permalink */
            8  => sprintf( __( 'Portfolio inviato. <a target="_blank" href="%s">Anteprima Portfolioo</a>', 'ufs11' ), esc_url( add_query_arg( 'preview', 'true', $permalink ) ) ),
            /* translators: 1: Publish box date format, see https://secure.php.net/date 2: Post permalink */
            9  => sprintf( __( 'Portfolioo programmato per: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Anteprima Portfolioo</a>', 'ufs11' ),
            date_i18n( __( 'M j, Y @ G:i', 'ufs11' ), strtotime( $post->post_date ) ), esc_url( $permalink ) ),
            /* translators: %s: post permalink */
            10 => sprintf( __( 'Portfolioo bozza aggiornato. <a target="_blank" href="%s">Anteprima Portfolioo</a>', 'ufs11' ), esc_url( add_query_arg( 'preview', 'true', $permalink ) ) ),
        );
